        ...
        >
          <div className="px-2">
            ...
            <div className="px-2 mb-1">
              <button
                className="text-white rounded w-full duration-300 px-2 py-2 mt-6 border-white bg-gradient-to-r from-red-500 via-orange-500 to-yellow-400 hover:scale-105"
                type="submit"
              >
                Sign in
              </button>
