      ...
      <section id="explore" className="w-[85%] mx-auto my-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 place-items-center">
          {categorie.map((item, index) => (
            <div className="w-[250px] h-[350px] rounded-t flex flex-col shadow relative">
              <div
              ...
              <div
                className={
                  counter !== 0
                    ? "w-[80px] rounded-2xl bg-white absolute top-[48%] left-2  flex justify-between items-center "
                    : "hidden"
                }
              >
